...
int main(int argc, char** argv) {
    ...
    // =========================================================================
    // STEP-1 ISOLATION: RUN_FFT_TEST block and warmup_buffers are DISABLED.
    // Hypothesis: the subFormat hack test and/or warmup corrupt V1_buf's
    // cuFFTMp per-buffer transpose metadata, causing X-direction partial-sum
    // (0.125 instead of 0.5 at kx=2).  Run with both disabled and observe
    // whether PROBE-X gives 0.5 and whether L2/div are correct.
    //
    // Original #if RUN_FFT_TEST { ... } #endif was here.
    // Original warmup_buffers(plan_r2c, plan_c2r, s) was here.
    // =========================================================================
